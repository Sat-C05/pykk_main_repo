          ...
          <div className={styles.detailsGrid}>
            <div className={styles.detailCard}>
              ...
              <div className={styles.text}>
                ...
                <p className={styles.meta}>Direct support available Mon—Sat.</p>
              </div>
            </div>
            ...
            <div className={styles.detailCard}>
              ...
              <div className={styles.text}>
                ...
                <p className={styles.meta}>We respond within 24 hours.</p>
              </div>
            </div>
            ...
            <div className={styles.detailCard}>
              ...
              <div className={styles.text}>
                ...
                <p>{company.address}</p>
                <p className={styles.meta}>Hyderabad, Telangana.</p>
              </div>
            </div>
            ...
            <div className={styles.detailCard}>
              ...
              <div className={styles.text}>
                ...
                <p>9:00 AM — 6:00 PM</p>
                <p className={styles.meta}>Monday through Saturday.</p>
              </div>
            </div>
          </div>
